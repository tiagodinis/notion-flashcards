export default function LevelIndicatorSVG({ dim = "16", color = "white" }) {
  return (
    <svg viewBox="0 0 47 47" width={dim} height={dim} fill={color} role="img">
      <title>Level indicator icon</title>
      <path
      ...
      />
      <path
        d="M12.899,28.164c-0.744-0.435-1.66-0.436-2.405-0.008l-9.279,5.303C0.266,34-0.2,35.113,0.081,36.169
			c0.28,1.057,1.236,1.792,2.329,1.792h9.28c1.331,0,2.41-1.079,2.41-2.41v-5.304C14.101,29.39,13.643,28.594,12.899,28.164z"
      />
      <path
        d="M45.799,9.364c-0.744-0.432-1.66-0.434-2.405-0.007l-9.279,5.302c-0.751,0.429-1.215,1.228-1.215,2.093v18.799
